...
enum L10n {
    ...
    enum Home {
        ...
        static let holdingsEmptyFundedTitle = String(localized: "home.holdings_empty_funded_title")
        static let holdingsEmptyFundedMessage = String(localized: "home.holdings_empty_funded_message")
