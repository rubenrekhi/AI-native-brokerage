...
enum L10n {
    ...
    enum Home {
        ...
        static let portfolioChartAccessibilityLabel = String(localized: "home.portfolio_chart_accessibility_label")
        static func portfolioChartAccessibilityValue(_ equity: String, _ period: String) -> String {
            String(format: String(localized: "home.portfolio_chart_accessibility_value"), equity, period)
        }
        static func portfolioGainText(_ amount: String, _ percent: String, _ period: String) -> String {
            String(format: String(localized: "home.portfolio_gain_text"), amount, percent, period)
        }
    ...
    enum Settings {
        ...
        static let tradeHistoryEmptyMessage = String(localized: "settings.trade_history_empty_message")
        static let tradeHistoryFilteredEmptyTitle = String(localized: "settings.trade_history_filtered_empty_title")
        static let tradeHistoryFilteredEmptyMessage = String(localized: "settings.trade_history_filtered_empty_message")
        static let tradeHistoryErrorTitle = String(localized: "settings.trade_history_error_title")
        static let tradeHistoryFilterStatus = String(localized: "settings.trade_history_filter_status")
        static let tradeHistoryFilterSide = String(localized: "settings.trade_history_filter_side")
        static let tradeHistoryFilterTimeframe = String(localized: "settings.trade_history_filter_timeframe")
        static let tradeHistoryFilterHoldings = String(localized: "settings.trade_history_filter_holdings")
        static let tradeHistoryFilterAll = String(localized: "settings.trade_history_filter_all")
        static let tradeHistoryFilterPending = String(localized: "settings.trade_history_filter_pending")
        static let tradeHistoryFilterCompleted = String(localized: "settings.trade_history_filter_completed")
        static let tradeHistoryFilterFailed = String(localized: "settings.trade_history_filter_failed")
        static let tradeHistoryFilterBuy = String(localized: "settings.trade_history_filter_buy")
        static let tradeHistoryFilterSell = String(localized: "settings.trade_history_filter_sell")
        static let tradeHistoryFilter7d = String(localized: "settings.trade_history_filter_7d")
        static let tradeHistoryFilter30d = String(localized: "settings.trade_history_filter_30d")
        static let tradeHistoryFilter90d = String(localized: "settings.trade_history_filter_90d")
        static let tradeHistoryBuyLabel = String(localized: "settings.trade_history_buy_label")
        static let tradeHistorySellLabel = String(localized: "settings.trade_history_sell_label")
        static let tradeHistoryStatusPending = String(localized: "settings.trade_history_status_pending")
        static let tradeHistoryStatusCompleted = String(localized: "settings.trade_history_status_completed")
        static let tradeHistoryStatusFailed = String(localized: "settings.trade_history_status_failed")
        static let tradeHistoryStatusUnknown = String(localized: "settings.trade_history_status_unknown")
        static func tradeHistoryShares(_ qty: String) -> String {
            String(format: String(localized: "settings.trade_history_shares_format"), qty)
        }
        static func tradeHistoryPartialFill(filled: String, total: String) -> String {
            String(format: String(localized: "settings.trade_history_partial_fill_format"), filled, total)
        }
        ...
        static let personalDetailsTitle = String(localized: "settings.personal_details_title")
        static let personalDetailsFirstName = String(localized: "settings.personal_details_first_name")
        static let personalDetailsMiddleName = String(localized: "settings.personal_details_middle_name")
        static let personalDetailsLastName = String(localized: "settings.personal_details_last_name")
        static let personalDetailsDateOfBirth = String(localized: "settings.personal_details_date_of_birth")
        static let personalDetailsSsn = String(localized: "settings.personal_details_ssn")
        static let personalDetailsCitizenship = String(localized: "settings.personal_details_citizenship")
        ...
        static let editRiskToleranceTitle = String(localized: "settings.edit_risk_tolerance_title")
    ...
    enum Confirmation {
        static let statusProcessing = String(localized: "confirmation.status_processing")
        static let statusCancelled = String(localized: "confirmation.status_cancelled")
        static let statusSuperseded = String(localized: "confirmation.status_superseded")
        static let statusExpired = String(localized: "confirmation.status_expired")
        static let statusClosed = String(localized: "confirmation.status_closed")
