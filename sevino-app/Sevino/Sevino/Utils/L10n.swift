...
enum L10n {
    ...
    enum Settings {
        ...
        static let editSheetDone = String(localized: "settings.edit_sheet_done")
        static let editSheetCloseAccessibility = String(localized: "settings.edit_sheet_close_accessibility")
    }
