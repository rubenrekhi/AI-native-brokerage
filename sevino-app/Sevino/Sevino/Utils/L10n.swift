...
enum L10n {
    ...
    enum Home {
        ...
        static let holdingsEmptyUnfundedTitle = String(localized: "home.holdings_empty_unfunded_title")
        static let holdingsEmptyUnfundedMessage = String(localized: "home.holdings_empty_unfunded_message")
        static let accountPendingShort = String(localized: "home.account_pending_short")
        static let accountActionRequiredShort = String(localized: "home.account_action_required_short")
        static let accountRejectedShort = String(localized: "home.account_rejected_short")
        static let accountPendingTitle = String(localized: "home.account_pending_title")
        static let accountPendingMessage = String(localized: "home.account_pending_message")
        static let accountActionRequiredTitle = String(localized: "home.account_action_required_title")
        static let accountActionRequiredMessage = String(localized: "home.account_action_required_message")
        static let accountActionRequiredCTA = String(localized: "home.account_action_required_cta")
        static let accountRejectedTitle = String(localized: "home.account_rejected_title")
        static let accountRejectedMessage = String(localized: "home.account_rejected_message")
        static let holdingsCashOnlyHint = String(localized: "home.holdings_cash_only_hint")
