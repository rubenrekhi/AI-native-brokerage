...
struct AlpacaFundingSourceView: View {
    ...
    private func animateIn() async {
        ...
        await TypewriterAnimation.typeOut(L10n.Onboarding.alpacaFundingResponse1, reduceMotion: reduceMotion) { typed1 = $0 }
        try? await Task.sleep(for: .milliseconds(200))
        await TypewriterAnimation.typeOut(L10n.Onboarding.alpacaFundingResponse2, reduceMotion: reduceMotion) { typed2 = $0 }
